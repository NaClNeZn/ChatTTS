...
from utils.cfg import SPEAKER_DIR, LOGS_DIR, WAVS_DIR, MODEL_DIR, ROOT_DIR
from utils import utils, VERSION
from ChatTTS.utils import select_device
from utils.utils import is_chinese_os, modelscope_status
